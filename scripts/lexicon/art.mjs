...
import { RECIPES, NEG_SDXL, NEG_CHROMA } from "../art/recipes.mjs";   // the shared recipe table
...
// Exported so the song-cut pipeline can share ONE source of truth for art
// recipes instead of forking the table (scripts/art/styles.mjs augments
// these with categories and motion profiles). Export only — the night
