  ...
  return (
    <main className="relative grid min-h-screen place-items-center overflow-hidden px-4 py-12">
      ...
      <section className="relative w-full max-w-3xl overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.06] p-6 text-center shadow-2xl shadow-black/50 backdrop-blur-xl sm:p-10">
        ...
        <h1 className="relative mt-5 font-display text-5xl font-black uppercase tracking-[-0.06em] sm:text-7xl">Level Ready</h1>
        <p className="relative mx-auto mt-6 max-w-xl text-lg font-semibold leading-8 text-white/75">AI help for people and businesses in real life.</p>
        <p className="relative mx-auto mt-4 max-w-xl text-sm leading-7 text-white/55">Practical automation, setup help, and less “what button do I press?” energy.</p>
