  ...
  return (
    <main className="relative grid min-h-screen place-items-center overflow-hidden px-4 py-12">
      ...
      <section className="relative w-full max-w-3xl overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.06] p-6 text-center shadow-2xl shadow-black/50 backdrop-blur-xl sm:p-10">
        ...
        <h1 className="relative mt-5 font-display text-5xl font-black uppercase tracking-[-0.06em] sm:text-7xl">Music</h1>
        <p className="relative mx-auto mt-6 max-w-xl text-lg font-semibold leading-8 text-white/75">Suno transmissions, SoundCloud links, PulseBox/Jukebox plans, future visualizers.</p>
        <p className="relative mx-auto mt-4 max-w-xl text-sm leading-7 text-white/55">The speakers are warming up. Track embeds and experiments land here next.</p>
