  ...
  return (
    <main className="relative min-h-screen overflow-hidden">
      ...
      <section className="relative z-10 mx-auto max-w-5xl px-4 pb-12 pt-6 text-center sm:px-6 lg:px-8">
        ...
        <h1 className="mt-5 font-display text-5xl font-black uppercase tracking-[-0.06em] sm:text-7xl">Music</h1>
      ...
      <section className="relative z-10 mx-auto max-w-6xl px-4 pb-16 sm:px-6 lg:px-8">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {musicSources.map((source) => (
            <SignalPanel key={source.name} accentColor={source.color}>
      ...
      <section className="relative z-10 mx-auto max-w-6xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {tracks.map((track) => (
            <div
              key={track.id}
              className="relative overflow-hidden rounded-2xl border border-white/10 bg-white/[0.04] p-5 backdrop-blur transition hover:border-white/20"
            >
